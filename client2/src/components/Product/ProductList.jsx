...
const ProductList = () => {
  const {ListProduct,CategoryList,CategoryListRequest,BrandList,BrandListRequest, ListByFilterRequest}=ProductStore();
       ...
       <div className='row'>
           <div className='col-md-3 p-2'>
               <div className='card vh-100 p-3 shadow-sm'>
                   ...
                   <input value={Filter.priceMax} onChange={async(e)=>{await inputOnChange("priceMax",e.target.value)}} min ={0} max={1000000} step={1000} type="range" className='form-range'></input>

                   <label className='form-label mt-3'>Manium Price ${Filter.priceMin}</label>
                   <input value={Filter.priceMin} onChange={async(e)=>{await inputOnChange("priceMin",e.target.value)}} min ={0} max={1000000} step={1000} type="range" className='form-range'></input>
               </div>
           </div>
