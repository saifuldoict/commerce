...
const AppNavbar = () => {
  ...
  return (
    <>
                      ...
                      <div className='col-md-6'>
                          <span>
                              ...
                              <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01745032466
                              </span>
                          </span>
                      </div>
                      <div className="col-md-6">
        ...
        <nav className='navbar sticky-top shadow-sm-white navbar-expand-lg navbar-light m-0 py-3'>
            <div className='container'>
                        <Link className='navbar-brand' to="/">
                        <img className='img-fluid' src={logo}alt="" width="96px"></img>
                        </Link>
